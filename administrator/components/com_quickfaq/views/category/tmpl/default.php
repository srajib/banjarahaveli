		...
		<tr>
			<td valign="top">
				<table  class="adminform">
					<tr>
						...
						<td>
							<input name="title" value="<?php echo $this->row->title; ?>" size="50" maxlength="100" />
						</td>
						<td>
							<label for="published">
				...
				<table class="adminform">
					<tr>
						<td>
							...
							echo $this->editor->display( 'text',  $this->row->text, '100%;', '350', '75', '20', array('pagebreak', 'readmore') ) ;
							?>
						</td>
					</tr>
				</table>
			...
			<td valign="top" width="320px" style="padding: 7px 0 0 5px">
				...
				<table>
					...
					<tr>
						<td>
							<input type="button" class="button" value="<?php echo JText::_( 'ADD CATNAME' ); ?>" onclick="f=document.adminForm;f.metakey.value=f.title.value;" />
						</td>
					</tr>
				</table>
				<?php
