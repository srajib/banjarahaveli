...
class QuickfaqViewCategory extends JView
{
	...
	function display()
	{
		...
		$doc->link 	= JRoute::_('index.php?option=com_quickfaq&view=category&cid='.JRequest::getVar('cid',null, '', 'int'));
		...
		foreach ( $rows as $row )
		{
			...
			$link = JRoute::_('index.php?option=com_quickfaq&view=items&cid='. $category->slug .'&id='.$row->slug );
