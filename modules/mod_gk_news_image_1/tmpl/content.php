...
<div id="gk_news_image_1-<?php echo $this->module_id;?>" class="gk_news_image_1_wrapper">
	<?php if($this->outter_interface): ?>
	<div class="gk_news_image_1_outter_wrapper">
		...
		<ul class="gk_news_image_1_tick_buttons" style="z-index: <?php echo $highest_layer+3; ?>;">
			...
			<li class="tick"><?php echo $i; ?></li>
			<?php endfor; ?>
		</ul>
		<?php endif; ?>
		
		<?php if($this->outter_readmore) : ?>
		<div class="outter_readmore">Read more</div>
		<?php endif; ?>
	</div>
	<?php endif; ?>
	...
	<div class="gk_news_image_1_main_wrapper">
		...
		<?php if($this->show_ticks && $this->outter_interface == 0) : ?>
		<ul class="gk_news_image_1_tick_buttons" style="z-index: <?php echo $highest_layer+3; ?>;">
			<?php for($i = 0;$i < count($this->slides);$i++) : ?>
			<li class="tick"><?php echo $i; ?></li>
			<?php endfor; ?>
