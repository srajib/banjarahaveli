...
$daddcomm 	= "";
$drm	 	= "";
$dclear 	= '<div style="clear:both;" class="newItemSeparator"></div>';
$dempty 	= "";
$dimage		= "";
...
<div class="news_left" style="<?php if ($params->get('clearboth') == 1) { echo 'clear: both; ';} ?><?php echo $maincss;?>">
...
if ($top2) {
	if ($divcheck == 0) {
		$top2 = '<div class="news_title"> ' . $top2 . ' </div>';
	}
...
if ($fc && $flexi) {
	...
	if ($divcheck == 0) {
		$flexi = '<div class="newItemSeparator" style="' . $fields_box_css . ' ' . $under . '">' . $flexi . '</div>';
	}
...
<!--Added for Round Background Image-->
...
<div style="<?php echo $bottom_more_css; ?>"><a href="<?php echo $morelink; ?>" id="read_more" <?php if ($params->get('moreblank') == 1) {echo 'target="_blank"';} ?> ><?php 
if ($params->get('uselangfile') == 1) {
