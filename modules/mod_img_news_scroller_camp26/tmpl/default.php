...
$scrollerwidth		 	= $params->get( 'width', '637' );
...
$baseurl 				= JURI::base();
$scrollerwidth2			= $scrollerwidth-113;
						...
						<div class="scroller" style="width: <?php echo $scrollerwidth2;?>px; text-align:left;">
							<ul class="itemlist link-wocc linkro-wocc">
									...
									<li>
										...
										<img src="<?php echo $baseurl;?>/modules/mod_img_news_scroller_camp26/timthumb.php?src=<?php echo $baseurl;?>/media/image_scroller/<?php echo $menu_img1; ?>&amp;h=80&amp;w=111&amp;zc=1" alt="visit camp26.biz" width="111" height="80" style="padding: 0; border: none;"  />
									...
									<li>
										...
										<img src="<?php echo $baseurl;?>/modules/mod_img_news_scroller_camp26/timthumb.php?src=<?php echo $baseurl;?>/media/image_scroller/<?php echo $menu_img2; ?>&amp;h=80&amp;w=111&amp;zc=1" alt="visit camp26.biz" width="111" height="80" style="padding: 0; border: none;"  />
									...
									<li>
										...
										<img src="<?php echo $baseurl;?>/modules/mod_img_news_scroller_camp26/timthumb.php?src=<?php echo $baseurl;?>/media/image_scroller/<?php echo $menu_img3; ?>&amp;h=80&amp;w=111&amp;zc=1" alt="visit camp26.biz" width="111" height="80"  style="padding: 0; border: none;" />
									...
									<li>
										...
										<img src="<?php echo $baseurl;?>/modules/mod_img_news_scroller_camp26/timthumb.php?src=<?php echo $baseurl;?>/media/image_scroller/<?php echo $menu_img4; ?>&amp;h=80&amp;w=111&amp;zc=1" alt="visit camp26.biz" width="111" height="80"  style="padding: 0; border: none;" />
									...
									<li>
										...
										<img src="<?php echo $baseurl;?>/modules/mod_img_news_scroller_camp26/timthumb.php?src=<?php echo $baseurl;?>/media/image_scroller/<?php echo $menu_img5; ?>&amp;h=80&amp;w=111&amp;zc=1" alt="visit camp26.biz" width="111" height="80" style="padding: 0; border: none;"  />
								...
								<?php if ($menu_status6==1) { ?>
									<li>
										...
										<img src="<?php echo $baseurl;?>/modules/mod_img_news_scroller_camp26/timthumb.php?src=<?php echo $baseurl;?>/media/image_scroller/<?php echo $menu_img6; ?>&amp;h=80&amp;w=111&amp;zc=1" alt="visit camp26.biz" width="111" height="80"  style="padding: 0; border: none;" />
								...
								<?php if ($menu_status7==1) { ?>
									<li>
										...
										<img src="<?php echo $baseurl;?>/modules/mod_img_news_scroller_camp26/timthumb.php?src=<?php echo $baseurl;?>/media/image_scroller/<?php echo $menu_img7; ?>&amp;h=80&amp;w=111&amp;zc=1" alt="visit camp26.biz" width="111" height="80"  style="padding: 0; border: none;" />
								...
								<?php if ($menu_status8==1) { ?>
									<li>
										...
										<img src="<?php echo $baseurl;?>/modules/mod_img_news_scroller_camp26/timthumb.php?src=<?php echo $baseurl;?>/media/image_scroller/<?php echo $menu_img8; ?>&amp;h=80&amp;w=111&amp;zc=1" alt="visit camp26.biz" width="111" height="80" style="padding: 0; border: none;"  />
								...
								<?php if ($menu_status9==1) { ?>
									<li>
										...
										<img src="<?php echo $baseurl;?>/modules/mod_img_news_scroller_camp26/timthumb.php?src=<?php echo $baseurl;?>/media/image_scroller/<?php echo $menu_img9; ?>&amp;h=80&amp;w=111&amp;zc=1" alt="visit camp26.biz" width="111" height="80" style="padding: 0; border: none;"  />
								...
								<?php if ($menu_status10==1) { ?>
									<li>
										...
										<img src="<?php echo $baseurl;?>/modules/mod_img_news_scroller_camp26/timthumb.php?src=<?php echo $baseurl;?>/media/image_scroller/<?php echo $menu_img10; ?>&amp;h=80&amp;w=111&amp;zc=1" alt="visit camp26.biz" width="111" height="80"  style="padding: 0; border: none;" />
